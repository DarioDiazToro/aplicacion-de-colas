...
socket.on("estado-actual", (payload) => {
  ...
  if (ticket1) {
    lblTicket1.innerText = "Tikect " + ticket1.numero;
    lblEscritorio1.innerText = ticket1.escritorio;
  }
  if (ticket2) {
    lblTicket2.innerText = "Tikect " + ticket2.numero;
    lblEscritorio2.innerText = ticket2.escritorio;
  }
  if (ticket3) {
    lblTicket3.innerText = "Tikect " + ticket3.numero;
    lblEscritorio3.innerText = ticket3.escritorio;
  }
  if (ticket4) {
    lblTicket4.innerText = "Tikect " + ticket4.numero;
